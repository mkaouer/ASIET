...
public class Connexion extends JFrame {
	...
	private void initialize() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/youma.jpg")));
		...
		if (bConnect == null) {
			...
			bConnect.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(txtLog.getText().equals(new String("administrateur")))// || txtLog.getText()=="ADMINISTRATEUR")
						if(String.copyValueOf(pass.getPassword()).equals(new String("emsi123")))
						{
							Main.connecte=true;
							setVisible(false);
						}
