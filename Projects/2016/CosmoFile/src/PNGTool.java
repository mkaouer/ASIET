...
//PNG TO SVG AND EXCEPTIONS

public class PNGTool {
	String [] SupportedFormat={".jpeg",".bmp",".gif",".jpg",".tiff",".tif",".raw",".pnm",".pdf",".html",".ico"};
	ImageTool IT = new ImageTool(); 
	
	public void PngConverter(String Path,String Target,String Extension){
