...
public class FenInfos extends JFrame {
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(220, 177, 60, 26));
			jButton.setText("OK");
		}
