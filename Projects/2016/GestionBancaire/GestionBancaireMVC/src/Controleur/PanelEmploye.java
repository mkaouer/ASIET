...
public class PanelEmploye extends JPanel 
{
	...
	private JButton getJButtonVoirEmp() {
		if (jButtonVoirEmp == null) {
			...
			jButtonVoirEmp.setBounds(190, 23, 200, 25);
		}
	...
	private JComboBox getJComboBox() {
		if (jComboBox == null) {
			...
			jComboBox.setBounds(160, 20, 10, 25);
		}
		return jComboBox;
	}
	...
	jButtonSupprimerEmploye.setBounds(145, 23, 225, 130);
		}
	...
	private JButton getJButtonAjouteEmploye() {
		if (jButtonAjouteEmploye == null) {
			...
			jButtonAjouteEmploye.setBounds(145, 23, 225, 180);
		}
	...
	private JButton getJButtonModifEmpl() {
		if (jButtonModifEmpl == null) {
			...
			jButtonModifEmpl.setBounds(145, 23, 225, 155);
		}
