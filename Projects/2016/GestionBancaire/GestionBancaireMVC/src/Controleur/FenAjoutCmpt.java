...
public class FenAjoutCmpt extends  {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel1.setBounds(100, 20, 31, 66);
			jLabel1.setLocation(new Point(31, 66));
			jLabel = new JLabel();
			jLabel.setPreferredSize(new Dimension(100, 20));
			jLabel.setLocation(new Point(setBounds));
			jLabel.setBounds(100, 20, 31, 66);
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(185, 128, 75, 27);
