...
public class FenListCmpt extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabelNomClt.setBounds(100, 20, 16, 13);
	...
	private List getListComptes() {
		if (listComptes == null) {
			...
			listComptes.setBounds(19, 65, 402, 149));
		}
		return listComptes;
	}
	...
	private JButton getJButtonGestCompte() {
		if (jButtonGestCompte == null) {
			...
			jButtonGestCompte.setBounds(160, 27, 435, 110);
	...
	private JButton getJButtonAjouteCmpte() {
		if (jButtonAjouteCmpte == null) {
			...
			jButtonAjouteCmpte.setBounds(160, 27, 435, 140);
		}
	...
	private JButton getJButtonAjouteCmpte1() {
	   ...
	   jButtonSupprimerCompte.setBounds(160, 27, 435, 170);
