...
public class FenAjoutEmpl extends JFrame {
	...
	private JButton getJButton() {
		if (jButtonEmployé == null) {
			jButtonEmployé = new JButton();
			jButtonEmployé.setBounds(154, 202, 197, 24);
			jButtonEmployé.setText("Ajouter un employé");
		}
		return jButtonEmployé;
	}
	...
	private JTextField getJTextField() {
		if (jTextFieldNom == null) {
			...
			jTextFieldNom.setLocation(new Point(, 150, 20);
		}
	...
	private JComboBox getJComboBoxAgence() {
		if (jComboBoxAgence == null) {
			...
			jComboBoxAgence.setBounds(150, 20, 130, 170);
	...
	private JComboBox getJComboBoxCategorie() {
		if (jComboBoxCategorie == null) {
			...
			jComboBoxCategorie.setBounds(150, 20, 130, 145);
	...
	{
		jButtonEmployé.addActionListener(ajout);
	}
