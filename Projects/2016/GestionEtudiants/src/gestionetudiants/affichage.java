...
public class affichage
  ...
  private void jbInit() throws Exception {
    ...
    titre.setBounds(105, 11, 184, 38);
    taille_lb.setText("Taille:");
    taille_lb.setBounds(199, 17, 34, 15);
    style_lb.setText("style:");
    style_lb.setBounds(24, 18, 34, 15);
    apercu_pn.setBackground(Color.white);
    apercu_pn.setBounds(17, 208, 349, 48);
    apercu_pn.setLayout(null);
    test_lb.setText("Aperçu");
    test_lb.setBounds(125, 4, 211, 41);
